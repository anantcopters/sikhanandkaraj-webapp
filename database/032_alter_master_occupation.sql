...
-- ============================================================
--
-- Occupation IDs are being rebuilt from a definitive development
-- master list. Existing rows that reference occupations must
-- therefore be cleared before rebuilding the master.
--
-- Prelaunch photos are owned by prelaunch profiles and should be
-- cleared first unless the existing database FK already uses
-- ON DELETE CASCADE.
-- ============================================================

TRUNCATE TABLE prelaunch_photos
RESTART IDENTITY;

TRUNCATE TABLE prelaunch_profiles
RESTART IDENTITY;

TRUNCATE TABLE member_education_profession_details
RESTART IDENTITY;

DROP TABLE IF EXISTS master_occupations CASCADE;
DROP TABLE IF EXISTS master_occupation_categories CASCADE;
...
-- ============================================================
-- Restore member occupation foreign key
-- ============================================================

ALTER TABLE member_education_profession_details
ADD CONSTRAINT fk_member_education_profession_occupation FOREIGN KEY (occupation_id) REFERENCES master_occupations (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- ============================================================
-- Restore occupation foreign keys
-- ============================================================

ALTER TABLE member_education_profession_details
    ADD CONSTRAINT fk_member_education_profession_occupation
...
ALTER TABLE prelaunch_profiles
    ADD CONSTRAINT fk_prelaunch_occupation
    FOREIGN KEY (occupation_id)
    REFERENCES master_occupations(id)
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
