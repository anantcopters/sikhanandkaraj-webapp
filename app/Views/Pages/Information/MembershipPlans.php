...
<section
    ...
    <div class="container">
        ...
        <!-- Membership plans -->
            ...
            Commercial price/duration/quota data comes from membership_plans through
            MembershipPlanPresentationService. This page intentionally owns no
            independent commercial values.
        -->
        <div class="mb-5">
